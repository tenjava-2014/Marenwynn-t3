...
public enum Msg {
    ...
    MEND_ARM("&aYou splint your broken arm. Now you can deliver on pain."),
    MEND_ARM_OTHER("&aYou splint &6%s&a's broken arm."),
    MEND_ARM_OTHER_NOTICE("&6%s &asplints your broken arm. Time to get serious!"),
    MEND_LEGS("&aYou splint your broken leg. That's a load off..."),
    MEND_LEGS_OTHER("&aYou splint &6%s&a's broken leg."),
    MEND_LEGS_OTHER_NOTICE("&6%s &asplints your broken leg. Much better!"),
    NOTICE_BLEEDING("&cYou're bleeding!"),
    NOTICE_BROKEN_ARM("&cYour sword arm is broken! Damage halved!"),
